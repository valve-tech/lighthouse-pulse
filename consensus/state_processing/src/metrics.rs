...
lazy_static! {
     ...
     */
    pub static ref PARTICIPATION_PREV_EPOCH_HEAD_ATTESTING_GWEI_TOTAL: Result<Gauge> = try_create_float_gauge(
    ...
    pub static ref PARTICIPATION_PREV_EPOCH_TARGET_ATTESTING_GWEI_TOTAL: Result<Gauge> = try_create_float_gauge(
    ...
    pub static ref PARTICIPATION_PREV_EPOCH_SOURCE_ATTESTING_GWEI_TOTAL: Result<Gauge> = try_create_float_gauge(
    ...
    pub static ref PARTICIPATION_PREV_EPOCH_ACTIVE_GWEI_TOTAL: Result<Gauge> = try_create_float_gauge(
